...
function SubCategoryDetail() {
  ...
  const getOrder = async () => {
    ...
    try {
        setLoading(true)
        const response = await axios.get(`https://airobike.unotaxi.xyz/api/v1/subcategories/${params.id}/`, config)
        .then(res => {
            const o = res.data;
...
//   UPDATE 
  ...
  const putProduct = async (e) => {
    ...
    try {
        ...
        const response = await axios.put(`https://airobike.unotaxi.xyz/api/v1/subcategories/${params.id}/`, formData, config)
        .then(res => {
    ...
    const deleteProduct = async () => {
        try {
            ...
            setLoading(true)
            // console.log(`user`, user)
            const response = await axios.delete(`https://airobike.unotaxi.xyz/api/v1/subcategories/${params.id}/`, config)
            .then(res => {
                // const productUpdated = res.data;
