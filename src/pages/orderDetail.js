...
function OrderDetail() {
  ...
  const getOrder = async () => {
    ...
    try {
        setLoading(true)
        const response = await axios.get(`https://airobike.unotaxi.xyz/api/v1/orders/${params.id}/`, config)
        .then(res => {
            const o = res.data;
...
//   UPDATE 
    ...
    const putPaidProduct = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://airobike.unotaxi.xyz/api/v1/orders/${params.id}/paid/`, formData, config)
            .then(res => {
    ...
    const putDeliveredProduct = async (e) => {
        ...
        try {
            ...
            setLoading(true)
            // console.log(`user`, user)
            const response = await axios.put(`https://airobike.unotaxi.xyz/api/v1/orders/admin/${params.id}/deliver/`, formData, config)
            .then(res => {
                const productUpdated = res.data;
                console.log(`productUpdated =`, productUpdated)
    ...
    const deleteProduct = async () => {
        try {
            ...
            setLoading(true)
            // console.log(`user`, user)
            const response = await axios.delete(`https://airobike.unotaxi.xyz/api/v1/orders/admin/${params.id}/delete/`, config)
            .then(res => {
                // const productUpdated = res.data;
