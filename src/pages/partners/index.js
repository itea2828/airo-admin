    ...
    (o)=>{
        return(
            <tr>
                ...
                {o.isConfirmed?
                <td style={{paddingLeft: '10px', paddingRight: '10px', fontSize: '13px', color:'green'}}>Подтвержден</td>
                :
                <td style={{paddingLeft: '10px', paddingRight: '10px', fontSize: '13px', color: 'red'}}>Не подтверж.</td>
                ...
                <div style={{paddingLeft: '10px', paddingRight: '10px'}}>
                  <table class="table table-striped">
                      <thead>
                          ...
                          <th style={{fontSize: '13px', paddingLeft: '10px', paddingRight: '10px'}}>Имя пользователья</th>
                          <th style={{fontSize: '13px',textAlign: 'left', paddingLeft: '10px', paddingRight: '10px'}}>Тел.</th>
                          <th style={{width: '200px', textAlign: 'left', fontSize: '13px', paddingLeft: '10px', paddingRight: '10px'}}>Адрес</th>
                          <th style={{width: '100px', textAlign: 'left', fontSize: '13px', paddingLeft: '10px', paddingRight: '10px'}}>Статус</th>
