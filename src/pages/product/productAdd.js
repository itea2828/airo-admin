...
function ProductAdd() {
    ...
    const postProduct = async (e) => {
        ...
        try {
            ...
            if(title === '' || price === '' || pprice === '' || findedCat === undefined || selectedSubCategory === null ) {
                ...
                const response = await axios.post(`https://airobike.unotaxi.xyz/api/v1/products/post/`, formData, config)
                .then(res => {
